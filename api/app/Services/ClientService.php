...
class ClientService
{
    ...
    public function create(array $d): Client { return $this->repo->create($d); }
    public function update(Client $c, array $d): Client { return $this->repo->update($c, $d); }
    public function delete(Client $c): void { $this->repo->delete($c); }
}
